...
export const networkTo = `${basePath}/network`
export const softwareTo = `${basePath}/software`
export const geographyTo = `${basePath}/geography`
...
export const networkMethodologyTo = `${networkTo}/methodology`
