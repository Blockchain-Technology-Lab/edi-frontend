    ...
    <div className="space-y-16 font-roboto">
      ...
      <div className="card w-full bg-base-200 shadow-md overflow-hidden opacity-80">
        <div className="card-body p-4 text-base">
          ...
          <p className="">
            This page offers visualisations of the Tokenomics layer results. The
        ...
        <div className="card bg-base-200 shadow-md font-roboto pt-4">
          <div className="card-body p-4">
            ...
            <p>
              ...
              identity.On the Tokenomics layer, clustering enables the
              attribution of multiple independent addresses to the same wallet.
            </p>
            <p>
              Here, the clustering options are: &quot;Explorers&quot;,
              &quot;Staking keys&quot;, &quot;Multi-input Transactions&quot;,
              ...
              , <AppLink href="https://tzkt.io/">TzKT</AppLink>.
            </p>
            <p>
              &quot;Staking keys&quot; refers to the data collected from stake
              pools and validators that are used to attribute staking addresses
              to the same entity.
            </p>
            <p>
              We have now added the &apos;Multi-input Transactions&apos;
              clustering option. This feature allows attributing addresses to
              the same entity when they are used as inputs in the same
              transaction, a well-established heuristic for clustering addresses
              in UTXO-based ledgers.
            </p>
            <p>
              Explorer data is used for all ledgers except Cardano, whereas
              staking keys are used only for Cardano.
            </p>
            <p>
              ...
              developed in-house, &quot;Crystal Intelligence&quot; is an
              external integration. You can select &quot;Crystal
              Intelligence&quot; individually or in combination with our other
              clustering methods in the Clustering options.
            </p>
            <p>
      ...
      <div className="space-y-12 font-roboto">
        <div className="card bg-base-200 shadow-md font-roboto pt-4">
          ...
          <div className="card-body p-4 text-base">
            <p className="">
              A user can apply the decentralisation metrics on all or part of
              the data by choosing the relevant inclusion threshold on each
              layer. For example, if the option "Top 100" is chosen on the
              Tokenomics layer, then the metrics will apply on the top 100
              richest entities in the system, while ignoring the rest.
              Similarly, if the option "Above $0.01" is chosen in Tokenomics,
              the metrics will apply on entities that control tokens that were
              worth, at the given point in time, at least $0.01. Threshold
              options are: “Top 100”, “Top 1000”, “Top 50%”, “Above $0.01”,
              “None”. By default, no inclusion threshold is applied.
            </p>
          </div>
        </div>
      </div>
