      ...
      <div className="card w-full bg-base-200 shadow-md overflow-hidden opacity-80">
        <div className="card-body p-4 text-base">
          ...
          <p>
            ...
            accessibility standards. While we strive to adhere to WCAG
            guidelines, we recognise that achieving full accessibility may be an
            ongoing process. We are dedicated to continually improving the
            accessibility of our digital products and services.
          </p>
          <h2>
            <b>
          ...
          <p>
            This Accessibility Statement will be reviewed and updated regularly
            to reflect any changes in accessibility features or standards. The
            last update to this statement was on March 22, 2024.
          </p>
          <h2>
            <b>
              <u>Contact Us</u>
