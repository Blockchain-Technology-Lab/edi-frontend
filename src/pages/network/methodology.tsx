      ...
      <div className="card w-full bg-base-200 shadow-md overflow-hidden opacity-80">
        <div className="card-body p-4 text-base">
          ...
          <p>
            ...
            Cardano, Bitcoin Cash, Litecoin, Dogecoin and Zcash. On the Network
            layer, decentralisation is evaluated based on the distribution of
            nodes across organisations. The blockchain data that is needed to
            determine these distributions are collected using a crawler running
            on each network. The following metrics are presented in the
            dashboard: the Herfindahl-Hirschman index (HHI), the Nakamoto
            coefficient and the 1-concentration ratio. The results are based
            only on data we have collected and do not include extensive
            historical data.
          </p>
          <p>
